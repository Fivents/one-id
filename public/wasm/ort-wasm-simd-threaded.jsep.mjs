var ortWasmThreaded = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    if (D) {
      ...
      E = (C = !ra.lc) && 'em-pthread' == ra.workerData;
    }
    ('use strict');
    ...
    B.jsepInit = (a, b) => {
      ta?.();
      if ('webgpu' === a) {
        [B.Mb, B.Tb, B.Xb, B.Nb, B.Wb, B.jb, B.Yb, B.$b, B.Ub, B.Vb, B.Zb] = b;
        const c = B.Mb;
    ...
    if (E) {
      ...
      self.alert = function (...b) {
        postMessage({ Lb: 'alert', text: b.join(' '), mc: Ia() });
      };
        ...
        try {
          ...
          if ('load' === d) {
            ...
            for (const g of c.handlers)
              if (!B[g] || B[g].proxy)
                ((B[g] = (...k) => {
                  postMessage({ Lb: 'callHandler', kc: g, args: k });
                }),
                  'print' == g && (Ea = B[g]),
                  'printErr' == g && (H = B[g]));
            m = c.wasmMemory;
    ...
    if (!E) {
      m = new WebAssembly.Memory({ initial: 256, maximum: 65536, shared: !0 });
      if (!(m.buffer instanceof SharedArrayBuffer))
        throw (
          H(
    ...
    var Lc = {
      ...
      850343: () => 'undefined' !== typeof wasmOffsetConverter,
      850400: (a) => {
        B.jb('Abs', a, void 0);
      },
      850451: (a) => {
      ...
      854660: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t) => {
      ...
      855061: (a, b, c, d, f, g, k, l, p, n, r, x, y, h) => {
        B.jb('ConvTranspose', a, {
          format: l ? 'NHWC' : 'NCHW',
          autoPad: b,
      ...
      855626: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t) => {
        B.jb('ConvTranspose', a, {
          format: p ? 'NHWC' : 'NCHW',
          autoPad: b,
          dilations: [c],
      ...
      856027: (a, b, c, d, f, g, k, l, p, n, r, x, y, h) => {
        B.jb('ConvTranspose', a, {
          format: l ? 'NHWC' : 'NCHW',
          autoPad: b,
          dilations: Array.from(z().subarray(c >>> 0, ((c >>> 0) + 2) >>> 0)),
      ...
      856683: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('AveragePool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      857058: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('AveragePool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      857429: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('MaxPool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      857796: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('MaxPool', a, {
          format: v ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ceil_mode: c,
      ...
      860455: (a, b, c, d, f, g, k, l, p) => {
        B.jb('Attention', a, {
          ...
          scale: f,
          doRotary: g,
          qkvHiddenSizes: k ? Array.from(z().subarray(Number(l) >>> 0, (Number(l) + k) >>> 0)) : [],
      ...
      860899: (a, b, c, d, f, g, k, l, p, n, r, x, y, h, t, v) => {
        B.jb('Conv', a, {
          format: x ? 'NHWC' : 'NCHW',
          auto_pad: b,
          ...
          w_is_const: () => !!e()[y >>> 0],
          activation: K(h),
          activation_params: t ? Array.from(ja().subarray(t >>> 0, v >>> 0)) : [],
        });
      },
      861395: (a) => {
        B.jb('Gelu', a, void 0);
      ...
      862407: (a, b) => B.$b(a, b, B.Eb.bc, B.Eb.errors),
      862519: (a, b, c) => {
        B.jb('SkipLayerNormalization', a, { epsilon: b, simplified: !!c });
      },
    };
    ...
    var Oc = (a) => {
      ...
      Rc = (a) => {
        ...
        N[a.Ab] = b;
        b.Ab = a.Ab;
        var c = { cmd: 'run', start_routine: a.cc, arg: a.Pb, pthread_ptr: a.Ab };
        D && b.unref();
        b.postMessage(c, a.ic);
        return 0;
      },
      O = 0,
      P = (a, b, ...c) => {
        for (var d = 2 * c.length, f = Sc(), g = Tc(8 * d), k = g >>> 3, l = 0; l < c.length; l++) {
          var p = c[l];
          'bigint' == typeof p
      ...
      new Promise((b) => {
        a.onmessage = (g) => {
          ...
          if (g.targetThread && g.targetThread != Ia()) {
            ...
            ((g = g.thread), (k = N[g]), delete N[g], Oc(k), ad(g), M.splice(M.indexOf(k), 1), (k.Ab = 0));
        ...
        a.postMessage({ cmd: 'load', handlers: c, wasmMemory: m, wasmModule: Ua });
      });
    function $c(a) {
    ...
    function ob(a, b, c, d) {
      ...
      a = { cc: c, Ab: a, Pb: d, ic: f };
      return E ? ((a.Lb = 'spawnThread'), postMessage(a, f), 0) : Rc(a);
    }
    var kd = 'undefined' != typeof TextDecoder ? new TextDecoder('utf8') : void 0,
      ld = (a, b, c) => {
        ...
        var d = b + c;
        for (c = b; a[c] && !(c >= d); ) ++c;
        if (16 < c - b && a.buffer && kd)
          return kd.decode(a.buffer instanceof SharedArrayBuffer ? a.slice(b, c) : a.subarray(b, c));
        for (d = ''; b < c; ) {
          var f = a[b++];
          if (f & 128) {
            var g = a[b++] & 63;
    ...
    function Hb(a, b, c, d, f) {
      ...
      S(a, {
        ...
        toWireType: k,
        argPackAdvance: T,
        readValueFromPointer: ud(b, c, 0 !== d),
        Db: null,
      });
    }
    function Ib(a, b, c) {
      ...
      c = Q(c >>> 0);
      S(a, { name: c, fromWireType: d, argPackAdvance: T, readValueFromPointer: d }, { Rb: !0 });
    }
    function Jb(a, b) {
      a >>>= 0;
      b = Q(b >>> 0);
      ...
      S(a, {
        ...
        fromWireType: function (d) {
          ...
          if (c)
            ...
            n = Array(f);
            for (l = 0; l < f; ++l) n[l] = String.fromCharCode(w()[(g + l) >>> 0]);
            n = n.join('');
          }
          X(d);
          return n;
    ...
    function Kb(a, b, c) {
      ...
      if (2 === b) {
        ...
        var g = Dd;
        var k = (l) => ea()[(l >>> 1) >>> 0];
      } else 4 === b && ((d = Ed), (f = Fd), (g = Gd), (k = (l) => A()[(l >>> 2) >>> 0]));
      S(a, {
        name: c,
        fromWireType: (l) => {
          for (var p = A()[(l >>> 2) >>> 0], n, r = l + 4, x = 0; x <= p; ++x) {
            var y = l + 4 + x * b;
            if (x == p || 0 == k(y))
              ((r = d(r, y - r)), void 0 === n ? (n = r) : ((n += String.fromCharCode(0)), (n += r)), (r = y + b));
          }
          X(l);
          return n;
        },
    ...
    function Lb(a, b) {
      a >>>= 0;
      b = Q(b >>> 0);
      S(a, { Sb: !0, name: b, argPackAdvance: 0, fromWireType: () => {}, toWireType: () => {} });
    }
    var Mb = () => 1;
    function Nb(a) {
    ...
    function La(a) {
      ...
      'function' === typeof Atomics.jc &&
        (Atomics.jc(z(), a >>> 2, a).value.then(Ra), (a += 128), Atomics.store(z(), a >>> 2, 1));
    }
    var Ra = () => {
      var a = Ia();
      a && (La(a), Hd(Id));
                ...
                try {
                  ...
                  I ||
                    ...
                    F &&
                      1 === Z &&
                      0 === Qd.length &&
                      ((Z = 0), (O += 1), Od(Rd), 'undefined' != typeof Fibers && Fibers.oc()));
                }
              }
            : d;
      return b;
        ...
        if (0 === Z) {
          ...
          a((d = 0) => {
            if (!I && ((Sd = d), (b = !0), c)) {
              Z = 2;
              Od(() => ae(F));
              'undefined' != typeof Browser && Browser.Jb.Qb && Browser.Jb.resume();
              d = !1;
              try {
                var f = Zd();
              } catch (l) {
          ...
          b ||
            ((Z = 1),
            (F = Yd()),
            'undefined' != typeof Browser && Browser.Jb.Qb && Browser.Jb.pause(),
            Od(() => be(F)));
    ...
    function Yb(a, b, c) {
      ...
      d.Sb ||
        (l.push('emval_returnValue'), p.push(Nd), (f += '  return emval_returnValue(retType, destructorsRef, rv);\n'));
      l.push(f + '};\n');
      a = ke(l)(...p);
    ...
    function nc(a, b, c, d) {
      ...
      g = a(g);
      k = a(k);
      l < f ? (od(g, c, 17), od(k, d, 17)) : (od(g, d, 17), od(k, c, 17));
    }
    var oe = [],
      pe = (a, b) => {
        oe.length = 0;
    ...
    function yc(a) {
      ...
      for (var c = 1; 4 >= c; c *= 2) {
        ...
        d = Math.max(a, d);
        a: {
          f = (f.min.call(f, 4294901760, d + ((65536 - (d % 65536)) % 65536)) - m.buffer.byteLength + 65535) / 65536;
          try {
            m.grow(f);
            u();
            var g = 1;
    ...
    function Jc(a, b, c, d) {
      function f(h, t, v) {
        for (h = 'number' == typeof h ? h.toString() : h || ''; h.length < t; ) h = v[0] + h;
        return h;
      }
      function g(h, t) {
        return f(h, t, '0');
      ...
      function p(h) {
        var t = h.Bb;
        for (h = new Date(new Date(h.Cb + 1900, 0, 1).getTime()); 0 < t; ) {
          var v = h.getMonth(),
            aa = (le(h.getFullYear()) ? xe : ye)[v];
          if (t > aa - h.getDate())
            ((t -= aa - h.getDate() + 1),
              h.setDate(1),
              11 > v ? h.setMonth(v + 1) : (h.setMonth(0), h.setFullYear(h.getFullYear() + 1)));
          else {
      ...
      n = {
        ...
        '%j': (h) => {
          for (var t = 0, v = 0; v <= h.Hb - 1; t += (le(h.Cb + 1900) ? xe : ye)[v++]);
          return g(h.Kb + t, 3);
        },
        '%m': (h) => g(h.Hb + 1, 2),
        '%M': (h) => g(h.ec, 2),
        '%n': () => '\n',
        '%p': (h) => (0 <= h.Gb && 12 > h.Gb ? 'AM' : 'PM'),
        '%S': (h) => g(h.fc, 2),
        '%t': () => '\t',
        '%u': (h) => h.ub || 7,
        '%U': (h) => g(Math.floor((h.Bb + 7 - h.ub) / 7), 2),
        '%V': (h) => {
          var t = Math.floor((h.Bb + 7 - ((h.ub + 6) % 7)) / 7);
          2 >= (h.ub + 371 - h.Bb - 2) % 7 && t++;
          if (t) 53 == t && ((v = (h.ub + 371 - h.Bb) % 7), 4 == v || (3 == v && le(h.Cb)) || (t = 1));
          else {
            t = 52;
            var v = (h.ub + 7 - h.Bb - 1) % 7;
            (4 == v || (5 == v && le((h.Cb % 400) - 1))) && t++;
          }
          return g(t, 2);
        },
        '%w': (h) => h.ub,
    ...
    B._OrtCreateSessionOptions = (a, b, c, d, f, g, k, l, p, n) =>
      (B._OrtCreateSessionOptions = Y.Ga)(a, b, c, d, f, g, k, l, p, n);
    ...
    B._OrtRun = (a, b, c, d, f, g, k, l) => (B._OrtRun = Y.bb)(a, b, c, d, f, g, k, l);
    ...
    var Ia = () => (Ia = Y.fb)(),
      ...
      ae = (a) => (ae = Y.yb)(a),
      ce = () => (ce = Y.zb)();
    B.___start_em_js = 862621;
    B.___stop_em_js = 862843;
    function De() {
      var a = Y;
      a = Object.assign({}, a);
      var b = (d) => (f) => d(f) >>> 0,
