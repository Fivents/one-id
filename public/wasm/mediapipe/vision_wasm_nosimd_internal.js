  ...
  return async function (moduleArg = {}) {
    ...
    var getEmscriptenSupportedExtensions = (ctx) => {
      ...
      var supportedExtensions = [
        ...
        'WEBGL_depth_texture',
        'WEBGL_draw_buffers', // WebGL 2 extensions
    ...
    var findEventTarget = (target) => {
      ...
      else if (typeof target == 'string') return globalThis.document?.getElementById(target);
      return target;
    };
    ...
    var _emwgpuDeviceCreateRenderPipelineAsync = function (
      devicePtr,
      futureId_low,
      futureId_high,
      descriptor,
      ...
      WebGPU.Internals.futureInsert(
        futureId,
        device.createRenderPipelineAsync(desc).then(
          (pipeline) => {
    ...
    var _wgpuDeviceCreateTexture = (devicePtr, descriptor) => {
      ...
      if (nextInChainPtr !== 0) {
        ...
        textureBindingViewDimension =
          WebGPU.TextureViewDimension[HEAP32[(textureBindingViewDimensionDescriptor + 8) >> 2]];
      }
      var desc = {
        label: WebGPU.makeStringFromOptionalStringView(descriptor + 4),
    ...
    function EndGlQueryTiming(calc_name) {
      const gl = Module.canvas.getContext('webgl2');
      gl.endQuery(
        Module.WEBGL_QUERY_TIMER_EXT.TIME_ELAPSED_EXT,
        Module.WEBGL_SHADER_CALC_METRICS[UTF8ToString(calc_name)].query,
      );
    }
      ...
      if (!Module._imageConverter) {
        Module._imageConverter = (binaryPtr, binarySize, width, height, numChannels, makeDeepCopy, outputType) => {
          const imageData = new outputType(
            makeDeepCopy ? Module.HEAPU8.slice(binaryPtr, binaryPtr + binarySize).buffer : Module.HEAPU8.buffer,
            binaryPtr,
    ...
    var _free,
      ...
      _attachImageVectorListener,
      _registerModelResourcesGraphService,
      _bindTextureToStream,
      ...
      _allocateBoolVector,
      _allocateFloatVector,
      _allocateDoubleVector,
      _allocateIntVector,
      _allocateUintVector,
      _allocateStringVector,
      _addBoolVectorEntry,
      _addFloatVectorEntry,
      _addDoubleVectorEntry,
      _addIntVectorEntry,
      _addUintVectorEntry,
      _addStringVectorEntry,
      ...
      _addDoubleToInputSidePacket,
      _addFloatToInputSidePacket,
      _addIntToInputSidePacket,
      ...
      _attachBoolListener,
      _attachBoolVectorListener,
      _attachDoubleListener,
      _attachDoubleVectorListener,
      _attachFloatListener,
      _attachFloatVectorListener,
      _attachIntListener,
      _attachIntVectorListener,
      _attachUintListener,
      _attachUintVectorListener,
      _attachStringListener,
      _attachStringVectorListener,
    ...
    function assignWasmExports(wasmExports) {
      ...
      _kVersionStampBuildClientMintStatusStr = Module['_kVersionStampBuildClientMintStatusStr'] =
        wasmExports['od'].value;
      ...
      _kVersionStampBuildBaselineChangelistStr = Module['_kVersionStampBuildBaselineChangelistStr'] =
        wasmExports['Bd'].value;
      ...
      _kVersionStampBuildBaselineChangelistInt = Module['_kVersionStampBuildBaselineChangelistInt'] =
        wasmExports['Od'].value;
