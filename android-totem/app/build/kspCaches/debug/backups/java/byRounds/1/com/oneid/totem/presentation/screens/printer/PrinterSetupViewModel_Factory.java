...
public final class PrinterSetupViewModel_Factory implements Factory<PrinterSetupViewModel> {
  ...
  public PrinterSetupViewModel get() {
    return newInstance(appContextProvider.get(), printerConfigRepositoryProvider.get(), printerConnectionManagerProvider.get(), badgeRendererProvider.get());
  }
  ...
  public static PrinterSetupViewModel_Factory create(
    ...
    return new PrinterSetupViewModel_Factory(Providers.asDaggerProvider(appContextProvider), Providers.asDaggerProvider(printerConfigRepositoryProvider), Providers.asDaggerProvider(printerConnectionManagerProvider), Providers.asDaggerProvider(badgeRendererProvider));
  }
  ...
  public static PrinterSetupViewModel_Factory create(Provider<Context> appContextProvider,
      ...
      Provider<PrinterConnectionManager> printerConnectionManagerProvider,
      Provider<BadgeRenderer> badgeRendererProvider) {
    return new PrinterSetupViewModel_Factory(appContextProvider, printerConfigRepositoryProvider, printerConnectionManagerProvider, badgeRendererProvider);
  }
  ...
  public static PrinterSetupViewModel newInstance(Context appContext,
    ...
    return new PrinterSetupViewModel(appContext, printerConfigRepository, printerConnectionManager, badgeRenderer);
  }
}
