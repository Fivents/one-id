...
public class TotemInfoJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<TotemInfo>() {
  ...
  public override fun toString(): String = buildString(31) {
      append("GeneratedJsonAdapter(").append("TotemInfo").append(')') }

  public override fun fromJson(reader: JsonReader): TotemInfo {
    var id: String? = null
  ...
  public override fun toJson(writer: JsonWriter, value_: TotemInfo?): Unit {
    if (value_ == null) {
