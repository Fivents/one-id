import type { IAuthIdentityRepository } from '@/domain/auth/contracts/auth-identity.repository';
import { AuthIdentityEntity } from '@/domain/auth/entities/auth-identity.entity';
