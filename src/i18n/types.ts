...
export type TranslationSchema = {
  ...
  pages: {
    ...
    eventDetail: {
      ...
      removeTotemDescription: string;
      deleteParticipantDescription: string;
      invalidateCheckinDescription: string;
      editParticipantDescription: string;
      registerFaceDescription: string;
      assignTotemDescription: string;
      manualCheckinDescription: string;
      // Labels
      participant: string;
      totem: string;
      face: string;
      ...
      createNew: string;
      addParticipant: string;
      addParticipantAction: string;
      addParticipantTitle: string;
      editParticipantTitle: string;
      deleteParticipantTitle: string;
      deleteParticipantConfirm: string;
      registerFaceAction: string;
      registerFaceTitle: string;
      updateFaceAction: string;
      updateFaceTitle: string;
      assignTotem: string;
      assignTotemTitle: string;
      assignTotemSuccess: string;
      assignTotemError: string;
      removeTotemTitle: string;
      removeTotemConfirm: string;
      removeTotemSuccess: string;
      removeTotemError: string;
      invalidateCheckin: string;
      invalidateCheckinTitle: string;
      invalidateCheckinConfirm: string;
      invalidateCheckinSuccess: string;
      invalidateCheckinError: string;
      manualCheckinTitle: string;
      manualCheckinSuccess: string;
      manualCheckinError: string;
      manualAppCheckin: string;
      printConfigCreated: string;
      printConfigError: string;
      selectPrintConfig: string;
      // Camera actions
      openCamera: string;
      closeCamera: string;
      capturePhoto: string;
      capturePhotoError: string;
      cameraNotReady: string;
      webcamAccessError: string;
      faceImageUrlOptional: string;
      faceWebcamOptional: string;
      // Liveness
      enableLiveness: string;
      // Status messages
      checkinsStatus: string;
      creating: string;
      saving: string;
      assigning: string;
      invalidating: string;
      ...
      deleteParticipantError: string;
      deleteParticipantSuccess: string;
      participantAddedSuccess: string;
      participantUpdatedSuccess: string;
      registerFaceError: string;
      faceUpdated: string;
      ...
      aiUpdated: string;
      aiUpdateError: string;
      loadEventError: string;
      loadParticipantsError: string;
      loadCheckinsError: string;
      loadTotemsError: string;
      invalidStatusTransition: string;
      dateRangeError: string;
      selectParticipantError: string;
      // Document types
      idCard: string;
